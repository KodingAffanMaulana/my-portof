    ...
    return (
        <>
            <main className="main bg-gradient-to-tr from-[gray-900] to-[#00ffcc] p-4 sm:p-16">
                ...
                <div className="drop-shadow-2xl">
                    <section id="education" class="px-8 pb-8 sm:px-16 sm:pb-8 bg-white pt-8">
                        <h1 class="font-bold text-[14px] sm:text-2xl text-lime-800 pt-6 pb-1 sm:pb-3">Web Statis</h1>
